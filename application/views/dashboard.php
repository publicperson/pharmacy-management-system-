        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="well dash-box">
                ...
                <h2 class="text-right"><?php echo 'GH₵'.(number_format($today_purchase_number)); ?></h2>
              </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="well dash-box">
                <h4><span class="glyphicon glyphicon-usd" aria-hidden="true" style="color: #f5f5f5;"></span>  Total Purchase Due</h4>
                <h2 class='text-right'><?php echo 'GH₵'.(number_format($today_due)); ?></h2>
              </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="well dash-box">
              <h4><span class="far fa-calendar-alt" aria-hidden="true" style="color: #2e6da4;"></span> Sales of the Month</h4>
                <h2 class='text-right'><?php echo 'GH₵'.(number_format($monthly_sales_number)); ?> </h2>
              </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="well dash-box">
              <h4><span class="glyphicon glyphicon-equalizer" aria-hidden="true" style="color: orange;"></span> Today's Sale</h4>
              <h2 class='text-right'><?php echo 'GH₵'.(number_format($today_sale_number)); ?></h2>
            </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="well dash-box">
