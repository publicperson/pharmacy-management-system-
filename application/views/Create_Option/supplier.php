                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-6" style="">
                                    ...
                                    <input type="text" class="form-control" id="company_name" placeholder="XYZ Suppliers"
                                        name="company_name">
                                </div>
                                <div class="col-sm-6">
                                    <label for="mobile">Contact</label>
                                    <input type="text" class="form-control" id="mobile" placeholder="+233 234567890 "
                                        name="mobile">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6" style="">
                                    ...
                                    <input type="text" class="form-control" id="address" placeholder="GA-123-4567"
                                        name="address">
                                </div>
                                <div class="col-sm-6">
                                    <label for="previous_due">Previous Due</label>
                                    <input type="text" class="form-control" id="previous_due" placeholder="GH₵"
                                        name="previous_due">
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <table class="table table-striped table-bordered table-hover">
								...
								foreach ($all_value as $single_value) {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right;"><?php echo 'GH₵'.$single_value->previous_due; ?></td>
