						...
						<div class="box-body">
							...
							<div class="row">
								...
								<div class="col-sm-3" style="">
									...
									<input type="text" class="form-control" id="unit_price" placeholder="GH₵" name="unit_price"
										   value="<?php echo $unit_price; ?>">
								</div>
								<div class="col-sm-3">
									<label for="purchase_price">Total Amount</label>
									<input type="text" class="form-control" id="purchase_price" placeholder="GH₵"
										   name="purchase_price" value="<?php echo $purchase_price; ?>">
								</div>
								<div class="col-sm-3">
									<label for="unit_sales_price">Selling Price</label>
									<input type="text" class="form-control" id="unit_sales_price" placeholder="GH₵"
							...
							<div class="row">
								...
								<div class="col-sm-3">
									...
									<input type="text" class="form-control" id="purchase_paid" placeholder="GH₵"
										   name="purchase_paid" value="<?php echo $purchase_paid; ?>">
								</div>
								<div class="col-sm-3">
									<label for="purchase_due">Purchase Due</label>
									<input type="text" class="form-control" id="purchase_due" placeholder="GH₵"
