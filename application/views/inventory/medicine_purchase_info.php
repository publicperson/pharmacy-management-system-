                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3" style="">
                                    ...
                                    <input type="number" step=any class="form-control" id="unit_price" placeholder="GH₵"  name="unit_price">
                                </div>
								<div class="col-sm-3">
									<label for="purchase_price">Total Amount</label>
									<input type="number" step=any class="form-control" id="purchase_price" placeholder="GH₵"
										   name="purchase_price">
								</div>
								<div class="col-sm-3">
									<label for="unit_sales_price">Selling Price</label>
									<input type="number" step=any class="form-control" id="unit_sales_price" placeholder="GH₵"
                            ...
                            <div class="row">
								...
								<div class="col-sm-3">
									...
									<input type="number" class="form-control" id="purchase_paid" placeholder="GH₵"
										   name="purchase_paid">
								</div>
								<div class="col-sm-3">
									<label for="purchase_due">Purchase Due</label>
									<input type="number" step=any class="form-control" id="purchase_due" placeholder="GH₵"
										   name="purchase_due">
								</div>
								<div class="col-sm-3">
                            ...
                            <table class="table table-striped table-bordered table-hover">
								...
								foreach ($all_value as $single_value) {
                                    ...
                                    <tr class="<?= (date("Y-m-d") >= $single_value->expiredate) ? 'expired' : '' ?>">
                                        ...
                                        <td style="text-align: center;"><?php echo 'GH₵'.$single_value->unit_price; ?></td>
										<td style="text-align: center;"><?php echo 'GH₵'.$single_value->purchase_price; ?></td>
										<td style="text-align: center;"><?php echo 'GH₵'.$single_value->unit_sales_price; ?></td>
										<td style="text-align: center;"><?php echo 'GH₵'.$single_value->purchase_paid; ?></td>
										<td style="text-align: center;"><?php echo 'GH₵'.$single_value->purchase_due; ?></td>
