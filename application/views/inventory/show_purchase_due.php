	...
	<table id="example2" class="table table-bordered table-hover">
		...
		foreach ($all_value as $single_value) {
			...
			<tr>
				...
				<td style="text-align: right;">GH₵<?php echo $single_value->purchase_paid; ?></td>
				<td style="text-align: right;">GH₵<?php echo $single_value->purchase_due; ?></td>

			</tr>
		<?php } ?>
		<tr>
			<td colspan="8">
				<p style="text-align: right; font-weight: bold;">Total Due: GH₵<?php echo $old_due; ?></p>
			</td>
		</tr>
		</tbody>
	</table>
