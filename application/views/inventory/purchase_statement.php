...
<!--											<td style="text-align: center;">--><?php //echo $single_value->unit_sales_price; ?><!--</td>-->
								...
								<tr style="font-weight: bolder;">
									...
									<td style="text-align: center;"colspan=""><?php echo 'GH₵'.$total_price; ?>/-</td>
									<td style="text-align: center;"colspan=""><?php echo 'GH₵'.$total_price; ?>/-</td>
									<td style="text-align: center;"colspan=""><?php echo 'GH₵'.$total_paid; ?>/-</td>
									<td style="text-align: center;"colspan=""><?php echo 'GH₵'.$total_due; ?>/-</td>
