...
//                        $total_price += ${'profit_loss_total' . $i};
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;"><?php echo 'GH₵'.${'purchase_price' . $i}; ?></td>
                            <td style="text-align: center;"><?php echo 'GH₵'.${'selling_price' . $i}; ?></td>
                            <td style="text-align: center;">
                                <?php
                                if (${'profit_loss_unit' . $i} > 0) {
                                    echo 'GH₵'.${'profit_loss_unit' . $i} . ' [Profit]';
                                } else {
                                    echo 'GH₵'.${'profit_loss_unit' . $i} * (-1) . ' [Loss]';
                                }
                                ?>
                            </td>
<!--                            <td style="text-align: center;">-->
