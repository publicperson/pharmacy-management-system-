				...
				foreach (${"product_result" . $i} as $single_value) {
					...
					<?php if ($single_value->particular != "Previous Due" && $single_value->particular != "Payment") { ?>
						<?php if ($one_time == 1) { ?>
							...
							<td style="text-align: center;"><?php echo 'GH₵'.$single_value->total_price; ?></td>
							<td style="text-align: center;"><?php echo 'GH₵'.$single_value->total_amount; ?></td>
							<td style="text-align: center;"><?php echo 'GH₵'.$single_value->total_discount; ?></td>
							<td style="text-align: center;"><?php echo 'GH₵'.$single_value->discount_price; ?></td>
						...
						<?php } else { ?>
							...
							<td style="text-align: center;"><?php echo 'GH₵'.$single_value->unit_sales_price; ?></td>
							<td style="text-align: center;"><?php echo 'GH₵'.$single_value->qty; ?> </td>
							<td style="text-align: center;"><?php echo 'GH₵'.$single_value->total_price; ?></td>
							<td style="text-align: center;"><?php echo 'GH₵'.$single_value->total_amount; ?></td>
							<td style="text-align: center;"><?php echo 'GH₵'.$single_value->total_discount; ?></td>
							<td style="text-align: center;"></td>
<!--							<td style="text-align: center;">--><?php //echo $single_value->discount_price; ?><!--/-</td>-->
			...
			<tr style="font-weight: bolder;">
				...
				<td style="text-align: center;">Total Sales: <?php echo 'GH₵'.$total_price2; ?>/-</td>
