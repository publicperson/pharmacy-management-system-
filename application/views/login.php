...
<html lang="en">
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li  style="align-self: center;"><a href="./">PSIMS BY ELPIDIO TOSSOU</a></li>
          </ul>
    ...
    <header id="header">
      <div class="container">
        <div class="col-md-10">
          ...
          Pharmacy Management System - Admin Login
          </h2>
        </div>
       </div>
      </div>
  ...
  <p> Pharmacy Sales and Inventory Management System,  <?php echo date('Y')?>  </p>
	</footer>
